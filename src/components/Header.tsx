...
const Header: React.FC<HeaderProps> = ({ onShare, onSave }) => {
  ...
  const handleSocialShare = (platform: string, e: React.MouseEvent) => {
    ...
    // For now, this just triggers the regular share function
    onShare();
  };
  ...
  return (
    <header className="flex items-center justify-between px-4 py-4 bg-editor-darker dark:bg-editor-darker light:bg-white transition-colors duration-300">
      <div className="flex items-center">
        ...
        {user && <span className="ml-4 text-sm opacity-75 dark:text-white light:text-slate-600">Welcome, {user.username}</span>}
      </div>
        ...
        <div className="tooltip-container">
          ...
          <div className="tooltip-content">
            <div className="social-icons">
              <a href="#" className="social-icon twitter" onClick={(e) => handleSocialShare('twitter', e)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="#" className="social-icon facebook" onClick={(e) => handleSocialShare('facebook', e)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="#" className="social-icon linkedin" onClick={(e) => handleSocialShare('linkedin', e)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
